            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Tatiana Zhapan</span>
                </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="../tickets/ticket.html"><i class="fa fa-circle-o"></i> Registrar Ticket</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Liberar Espacio</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Liberar Ticket</li>
          </ol>
        </section>
            ...
            <div class="box-body">
              <div class="row">
                <table cellspacing="0" cellpadding="0">     
                  <tr>        
                  <?php while ( $espacio = mysql_fetch_array($espacios)) { ?>

                       <th class="espacios"><?php echo $espacio["nombre_espacio"] ?>   </th>
                  <?php  } ?>
                    <!-- <th>Title</th>
                    <th>Title</th>
                    <th>Title</th>
                ...
                <div class="box-body">
                  <form role="form">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Placa ..." disabled>
                    </div>
                    <!-- text input -->
                    <div class="form-group">
