<?php 
    ...
    conxecion();
    $pisos = consultar("piso");
    $edificios = consultar("edificio");
    Salir();
 ?>
<!DOCTYPE html>
<html>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="../tickets/liberar.html"><i class="fa fa-circle-o"></i> Liberar Espacio</a></li>
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
                  <form role="form">
                    ...
                    <!-- text input -->
                    <div class="form-group">
                      <label>Palca del vehiculo</label>
